...
(async () => {
  try {
    ...
    console.log('Navigating to https://poultry-management-theta.vercel.app/documentation/index.html...');
    await page.goto('https://poultry-management-theta.vercel.app/documentation/index.html', { waitUntil: 'domcontentloaded', timeout: 60000 });
