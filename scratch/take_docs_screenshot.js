...
(async () => {
  try {
    ...
    console.log('Navigating to http://localhost:3000/documentation/usage-guide.html...');
    await page.goto('http://localhost:3000/documentation/usage-guide.html', { waitUntil: 'domcontentloaded', timeout: 60000 });
