...
export default function CCTVPage() {
  ...
  useEffect(() => {
    fetch('/api/auth/me')
      ...
      .then(data => {
        ...
        // Free tier has CCTV disabled by default unless Super Admin overrides
        if (tier === 'free') {
  ...
  return (
    <FeatureGuard
      ...
      featureName="CCTV Live Surveillance"
      description="CCTV Live Surveillance is restricted by Super Admin feature controls or requires a Commercial Pro or Enterprise Plus subscription tier."
    >
      <div className="space-y-8 max-w-4xl mx-auto py-8 font-sans">
        <Card className="border border-slate-200 bg-white rounded-3xl p-8 sm:p-12 text-center shadow-sm space-y-6">
          <div className="inline-flex items-center gap-2 bg-amber-100 text-amber-800 border border-amber-200 font-extrabold text-xs uppercase px-4 py-1.5 rounded-full">
            ...
            <span>Hardware Gateway & WebRTC</span>
          </div>
          ...
          <div className="space-y-2 max-w-xl mx-auto">
            ...
            <p className="text-slate-600 text-sm leading-relaxed font-medium">
              We provide 24/7 hardware IP camera streaming, V380 Pro NVR integration, and automated AI predator motion alerts for farm owners.
            </p>
          </div>
